...
if (isset($_POST['submit'])) {
    ...
    if ($count == 1) {
        ...
        echo '<script>alert("Login gagal silahkan cobalagi!");window.location="login.php"</script>';
    }
}
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Perpustakaan!</h1>
                                    </div>
                                    <form class="user" action="" method="POST">
                                        ...
                                        <button class="btn btn-warning btn-user btn-block" type="submit" name="submit">Login</button>
                                    </form>
                                    <hr>
